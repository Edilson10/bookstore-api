package com.edilson.bookstore.domain;
...
public class Livro implements Serializable {
	...
	@Length(min = 3, max = 50, message = "O campo titulo deve ter entre 3 a 0 5caracteres")
	...
	@Length(min = 10, max = 2000000, message = "O campo nome do autor deve ter entre 3 a 2000000 caracteres")
